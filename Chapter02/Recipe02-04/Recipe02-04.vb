...
Namespace Apress.VisualBasicRecipes.Chapter02
    ...
    Public Class Recipe02_04
        ...
        Public Shared Sub Main()
            ...
            Console.WriteLine(StringToBase64("Welcome to Visual Basic Recipes from Apress"))
            Console.WriteLine(Base64ToString("VwBlAGwAYwBvAG0AZQAgAHQAbwAgAFYAaQBzAHUAYQBsACAAQwAjACAAUgBlAGMAaQBwAGUAcwAgAGYAcgBvAG0AIABBAHAAcgBlAHMAcwA="))
