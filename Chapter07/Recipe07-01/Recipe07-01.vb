...
'  class called Recipe07-01.Designer.vb.  You can see this
'  file by selecting "Show All Files" in solution explorer.
Partial Public Class Recipe07_01

    Private Sub Recipe07_01_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '  Create an array of strings to use as the labels for 
        '  the dynamic checkboxes.
        Dim foods As String() = {"Grain", "Bread", "Beans", "Eggs", "Chicken", "Milk", "Fruit", "Vegetables", "Pasta", "Rice", "Fish", "Beef"}
