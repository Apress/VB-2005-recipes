        ...
        Public Shared Sub Main()
            ...
            Using con As New SqlConnection
                ...
                Using com As IDbCommand = con.CreateCommand
                    ...
                    com.CommandText = "SELECT BirthDate,FirstName,LastName FROM HumanResources.Employee e INNER JOIN Person.Contact c ON e.EmployeeID=c.ContactID ORDER BY BirthDate;SELECT * FROM HumanResources.Employee"
