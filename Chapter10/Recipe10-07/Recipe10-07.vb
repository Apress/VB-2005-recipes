    ...
    Public Class Recipe10_07
        ...
        Public Shared Sub Main(ByVal args As String())
            ...
            Using msg As New MailMessage
                ...
                msg.Body = "This is a message from Recipe 10-07 of Visual Basic Recipes.  Attached is the source file and the binary for the recipe."

                '  Attach the files to the e-mail message and set their MIME type.
                msg.Attachments.Add(New Attachment("..\..\Recipe10-07.vb", "text/plain"))
                msg.Attachments.Add(New Attachment("Recipe10-07.exe", "application/octet-stream"))
