...
Namespace Apress.VisualBasicRecipes.Chapter10
    ...
    Public Class ClientHandler
        ...
        Private Sub ProcessConnection()
            ...
            Using client
                ...
                Using reader As New BinaryReader(client.GetStream)
                    ...
                    If reader.ReadString = Recipe10_11Shared.RequestConnect Then
                        ...
                        Using writer As New BinaryWriter(client.GetStream)
                            ...
                            While Not message = Recipe10_11Shared.Disconnect
                                ...
                                If message = Recipe10_11Shared.RequestData Then
                                    ...
                                    StreamData(Nothing)
                                ElseIf message = Recipe10_11Shared.Disconnect Then
        ...
        Private Sub StreamData(ByVal asyncResult As IAsyncResult)
            ...
            If Not stopDataTransfer And Not Recipe10_11Server.Terminate Then
