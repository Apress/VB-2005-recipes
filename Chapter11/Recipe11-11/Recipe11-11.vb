...
Namespace Apress.VisualBasicRecipes.Chapter11
    ...
    Public Class Recipe11_11

        Public Shared Sub Method1()

            '  An imperative role-based security demand for the current
            '  principal to represent an identity with the name Amy.  The
            '  roles of the prinicpal are irrelevant.
            Dim perm As New PrincipalPermission("MACHINE\Amy", Nothing)
        ...
        Public Shared Sub Method3()
            ...
            '  to represent an identity with the name Amy AND be a member of the
            '  Managers role.
            Dim perm As New PrincipalPermission("MACHINE\Amy", "MACHINE\Managers")
        ...
        '  to represent an identity with the name Amy.
        <PrincipalPermission(SecurityAction.Demand, Name:="MACHINE\Amy")> _
        ...
        '  to represent an identity with the name AmY and be a member of the
        '  Managers role.
        <PrincipalPermission(SecurityAction.Demand, Name:="MACHINE\Amy", Role:="MACHINE\Managers")> _
