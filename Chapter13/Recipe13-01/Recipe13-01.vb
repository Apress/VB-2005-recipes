...
Namespace Apress.VisualBasicRecipes.Chapter13
    ...
    Public Class Employee
        ...
        '  Employee object.  You should declare the constructor protected
        ...
        '  deserialized object will not have an address value.
    ...
    Public Class Recipe13_01
        ...
        Public Shared Sub Main()
            ...
            Dim emp As New Employee("Alex", 35, "Retroville")
            ...
            Dim str As Stream = File.Create("Alex.bin")
