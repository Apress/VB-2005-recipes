...
Namespace Apress.VisualBasicRecipes.Chapter13
    ...
    Public Class Recipe13_04
        ...
        Public Shared Sub Main()
            ...
            newTeam.AddMember(New TeamMember("Kevin", "Ninja"))
            newTeam.AddMember(New TeamMember("Vicky", "Magician"))
            newTeam.AddMember(New TeamMember("Richard", "Paladin"))
            ...
            For Each member As TeamMember In newTeam
                Console.WriteLine(member.ToString)
                newTeam.AddMember(New TeamMember("Harry", "Wizard"))
            Next
