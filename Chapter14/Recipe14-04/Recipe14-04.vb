...
Namespace Apress.VisualBasicRecipes.Chapter14
    ...
    Public Class Recipe14_04
        ...
        Public Shared Sub Main()
            ...
            '  to a string.
            lastUser = Registry.GetValue("HKEY_CURRENT_USER\Software\Apress\Visual Basic 2005 Recipes", "", "Nobody")
            ...
            Else
                ...
                lastRun = DirectCast(Registry.GetValue("HKEY_CURRENT_USER\Software\Apress\Visual Basic 2005 Recipes", "LastRun", "Never"), String)

                '  Read the run count value and specify a default value of
                '  0 (zero).  Cast the returned Object to an Integer.
                runCount = DirectCast(Registry.GetValue("HKEY_CURRENT_USER\Software\Apress\Visual Basic 2005 Recipes", "RunCount", 0), Integer)
            End If
            ...
            Registry.SetValue("HKEY_CURRENT_USER\Software\Apress\Visual Basic 2005 Recipes", "", Environment.UserName, RegistryValueKind.String)
            ...
            '  registry.
            Registry.SetValue("HKEY_CURRENT_USER\Software\Apress\Visual Basic 2005 Recipes", "LastRun", DateTime.Now.ToString, RegistryValueKind.String)

            '  Update the usage count information.  Specify that this should
            '  be stored as an Integer value in the registry.
            runCount += 1
            Registry.SetValue("HKEY_CURRENT_USER\Software\Apress\Visual Basic 2005 Recipes", "RunCount", runCount, RegistryValueKind.DWord)
